...
export class Market extends Entity {
  ...
  set utilization(value: BigInt | null) {
    if (value === null) {
      this.unset("utilization");
    } else {
      this.set("utilization", Value.fromBigInt(value as BigInt));
    }
  }

  get borrowInterestRate(): BigInt | null {
    let value = this.get("borrowInterestRate");
    if (value === null) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set borrowInterestRate(value: BigInt | null) {
    if (value === null) {
      this.unset("borrowInterestRate");
    } else {
      this.set("borrowInterestRate", Value.fromBigInt(value as BigInt));
    }
  }

  get supplyInterestRate(): BigInt | null {
  ...
  set supplyInterestRate(value: BigInt | null) {
    if (value === null) {
      this.unset("supplyInterestRate");
    } else {
      this.set("supplyInterestRate", Value.fromBigInt(value as BigInt));
    }
  }
}
